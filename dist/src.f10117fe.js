...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Events":"src/models/Events.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
